...
from mydiabprod.models import Mydiabresults, Mydiabusers, Mydiabwelcome, Mydiabdocuments, Mydiabevents2
...
for row in lines:
    ...
    deploy2 = row[2]
    deploy3 = row[3]
    qq = Hresults(DateTime=str(deploy1), HGB=str(deploy2), TypeOf=str(deploy3), DeployDate=timezone.now(), UserName_id=1)
